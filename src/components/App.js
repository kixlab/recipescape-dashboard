...
import './App.css';
import { StatisticsDeck } from "./charts/statisticsField"
...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <StatisticsDeck statistics={STATISTICS}/>
 ...
 var RECIPES = [
   ...
   {recipeName: "very tasty cake",color:"brown", key:"r2", ingredients:["everything"," nice", "comes", "to", "an", "end", "overflow"], instructions:["wisk a and b", "but", "this", "should"]},
